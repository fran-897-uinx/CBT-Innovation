...
export default function PricingCard({
  ...
  const buttonLabel = plan === "Free" ? "Get Started" : "Upgrade Now";
  ...
  return (
    ...
    >
      ...
      <div className="mb-6">
        ...
        {period && <p className="text-gray-600 text-sm mt-1">{period}</p>}
      </div>
      ...
      <div className="space-y-3">
        {offers.map((offer, index) => (
          <div key={index} className="flex items-start">
            ...
            <p className="text-gray-700 text-sm leading-relaxed">{offer}</p>
          </div>
        ))}
      </div>
    </div>
