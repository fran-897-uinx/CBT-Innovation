        ...
        <div className="bg-white w-full py-20 px-4 text-center border-y border-gray-100">
            <div className="max-w-4xl mx-auto">
                ...
                <p className="text-lg sm:text-xl text-gray-600 max-w-2xl mx-auto mb-10 leading-relaxed">
                    Join thousands of students who have successfully prepared for their exams
                    with our comprehensive platform. Achieve your academic goals with confidence.
                </p>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-8 text-sm text-gray-500">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span className="font-medium text-gray-700">Join 10k+ students</span>
                    </div>
                </div>
            </div>
        </div>
