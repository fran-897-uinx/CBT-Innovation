    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          {/* Logo */}
          <a href="#home" className="flex items-center group gap-1.5">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <Link
              to="/auth"
              className="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2.5 px-6 rounded-lg shadow-md hover:shadow-lg transform hover:scale-105 transition-all duration-200"
            >
              Start Free Trial
            </Link>
          </div>
        ...
        >
          <nav className="flex flex-col gap-4 py-4 border-t border-gray-200 mt-4">
            ...
            <div className="flex flex-col gap-2 pt-2 border-t border-gray-200">
              <Link
                to="/auth"
                className="font-semibold text-gray-700 py-2 px-4 rounded-lg hover:bg-gray-100 transition-colors"
              >
                Sign In
              </Link>
              <Link
                to="/auth"
                className="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2.5 px-4 rounded-lg shadow-md transition-colors"
              >
                Start Free Trial
              </Link>
            </div>
