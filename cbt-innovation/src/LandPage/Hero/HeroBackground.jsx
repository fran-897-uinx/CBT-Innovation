        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center text-white px-4 max-w-5xl mx-auto">
          ...
          <div className="animate-fade-in-up space-y-6">
            ...
            <p className="text-lg md:text-xl lg:text-2xl max-w-3xl mx-auto leading-relaxed text-gray-200">
              Prepare for your exams with our comprehensive Computer-Based
              Testing platform. Get access to practice tests, detailed
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
              <Link
                to="/auth"
                className="bg-blue-600 cursor-pointer hover:bg-blue-700 text-white font-semibold px-8 py-4 rounded-lg shadow-lg transform hover:scale-105 transition-all duration-200"
              >
                Start Free Trial
              </Link>
