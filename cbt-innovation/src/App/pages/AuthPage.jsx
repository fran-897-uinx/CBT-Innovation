...
import { FaApple, FaGoogle, FaEnvelope, FaLock, FaUser, FaEye, FaEyeSlash } from 'react-icons/fa';
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            {isLogin && (
                                <div className="flex items-center justify-between text-sm">
                                    ...
                                    <button type="button" className="text-gray-900 font-medium hover:text-gray-700 transition-colors duration-200">
                                        Forgot password?
                                    </button>
                                </div>
                            )}
